/* app.js
 *
 * 这是我们的 Rss 订阅阅读器应用。它使用 Goole Feed Reader API 将 【RSS源】
 * 【转换】成我们能够利用的 【JSON 对象】。它还使用了 Handlebars 模板库和 Jquery.
 */

// 所有的名字和链接都是真实可用的
//
// 6.编辑 ./js/app.js 中的 allFeeds 变量，使 提供的测试出错，
// 然后观察 Jasmine 在应用程序中对该错误进行可视化处理的 结果。
var allFeeds = [
    {
        name: '优达学城 Blog',
